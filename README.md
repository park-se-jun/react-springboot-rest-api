...
- entity와 DTO를 어디에서 변환해 줘야 할까? 🤔
    - entity와 DTO의 사용위치에 대해 고민하게 되었습니다. model(entity) 객체를 controller 까지 올려도 될까? 반대로, DTO를 repository 까지 내려도 될까? 라는 고민을 가지게 되었는데
- 너무 많아지는 것 같은 DTO들
...
- entity란 뭘까...? 😵
    - 프로젝트를 진행하면서 entity가 뭘까에 대한 의문이 들기 시작했습니다. 저는
